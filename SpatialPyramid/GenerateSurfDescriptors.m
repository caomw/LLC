function [] = GenerateSurfDescriptors( imageFileList, imageBaseDir, dataBaseDir, params, canSkip, pfig )
...
fprintf('Building Surf Descriptors\n\n');
...
for f = 1:length(imageFileList)
    ...
    outFName = fullfile(dataBaseDir, sprintf('%s_surf.mat', baseFName));
    ...
    features = gen_surf(imageFName,params);
    sp_progress_bar(pfig,1,4,f,length(imageFileList),'Generating Surf Descriptors:');
